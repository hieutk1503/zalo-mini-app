  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      <div className="p-6 border-b border-gray-200 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold text-gray-800">Quản lý Quy hoạch</h2>
          <p className="text-sm text-gray-500 mt-1">Thông tin quy hoạch sử dụng đất, xây dựng</p>
        </div>
        <button 
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 text-gray-600 text-sm">
              ...
              <th className="p-4 border-b">Bản đồ/File đính kèm</th>
            ...
            {list.length === 0 ? (
              ...
              <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                <td className="p-4 align-top">
                  ...
                  <div className="text-sm text-gray-500 mt-1 line-clamp-2">{item.content}</div>
                </td>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              <h3 className="text-lg font-bold">{editingId ? 'Sửa Quy hoạch' : 'Thêm Quy hoạch'}</h3>
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Tiêu đề / Tên đồ án</label>
                <input 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Nội dung mô tả</label>
                <textarea 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Đường dẫn File Quyết định (URL PDF/Word)</label>
                <input 
