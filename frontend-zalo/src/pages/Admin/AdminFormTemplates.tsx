...
export default function AdminFormTemplates() {
    ...
    const handleOpenModal = (item?: FormTemplate) => {
        if (item) {
            ...
            setProcedureId(
                item.procedure_id ? item.procedure_id.toString() : "",
            );
        } else {
            setEditingId(null);
            setName("");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingId) {
                await axios.patch(
                    `${API_URL}/form-template/${editingId}`,
                    data,
                    {
            ...
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Quản lý các file biểu mẫu (Word/PDF) cho người dân tải
                        về
                    </p>
                </div>
                <button
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-xl max-h-[90vh] flex flex-col">
                        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                            <h3 className="text-lg font-bold">
                                {editingId ? "Sửa Mẫu Đơn" : "Thêm Mẫu Đơn"}
                            </h3>
                            <button
