...
export default function AdminImport() {
    ...
    const handleSyncAI = async () => {
        if (
            !window.confirm(
                "Quá trình đồng bộ dữ liệu sang AI có thể mất vài phút tùy vào số lượng thủ tục. Bạn có muốn bắt đầu?",
            )
        )
            return;
        setLoading(true);
        try {
            ...
            alert(
                "Đồng bộ dữ liệu AI thành công! Trợ lý ảo đã học được các thủ tục mới.",
            );
        } catch (error) {
            console.error(error);
                ...
                <div className="bg-indigo-600 px-6 py-4 text-white flex justify-between items-center gap-4">
                    <div>
                        ...
                        <p className="text-indigo-100 text-sm mt-1">
                            Upload file Excel (.xlsx, .csv) để thêm hàng loạt
                            thủ tục hành chính.
                        </p>
                    </div>
                    ...
                    {success && (
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-600 mt-2">
                                Dữ liệu thủ tục đã được cập nhật vào hệ thống.
                            </p>
                            <button
                    ...
                    {preview && (
                        <div className="animate-fade-in">
                            <div className="flex items-center gap-3 mb-6 bg-blue-50 text-blue-800 p-4 rounded-lg">
                                ...
                                <p>
                                    Đã phân tích file thành công. Phát hiện{" "}
                                    <strong>{preview.newCount}</strong> thủ tục
                                    mới và{" "}
                                    <strong>{preview.conflictCount}</strong> thủ
                                    tục đã tồn tại.
                                </p>
                            </div>
                                            ...
                                            <tbody>
                                                {preview.conflicts
                                                    ...
                                                    .map((row, idx) => (
                                                        <tr
                                                            key={idx}
                                                            className="border-b bg-yellow-50/30"
                                                        >
                            ...
                            <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 mt-6">
                                ...
                                <label className="flex items-start gap-3 cursor-pointer p-3 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 transition-colors">
                                    ...
                                    <span className="text-sm text-gray-600">
                                        Cập nhật dữ liệu thủ tục bị trùng mã
                                        bằng nội dung từ file. Nếu không chọn,
