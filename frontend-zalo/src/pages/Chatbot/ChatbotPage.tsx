...
import { useNavigate, Page, Header } from "zmp-ui";
...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState<Message[]>(() => {
        ...
        return [
            {
                id: 1,
                text: "Xin chào! Tôi là Trợ lý AI Tự Lạn Smart. Tôi có thể giúp gì cho bạn về thủ tục hành chính?",
                isBot: true,
            },
        ];
    });
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            setMessages(prev => [
                ...
                {
                    id: Date.now() + 1,
                    text: "Xin lÃ¡Â»â€”i, AI Ã„â€˜ang gÃ¡ÂºÂ·p sÃ¡Â»Â± cÃ¡Â»â€˜ kÃ¡ÂºÂ¿t nÃ¡Â»â€˜i. Vui lÃƒÂ²ng thÃ¡Â»Â­ lÃ¡ÂºÂ¡i sau.",
                    isBot: true,
                },
            ]);
        } finally {
    ...
    return (
        <Page className="flex flex-col bg-gray-50 h-full relative">
            <Header
                title="TrÃ¡Â»Â£ lÃƒÂ½ Ã¡ÂºÂ£o TÃ¡Â»Â± LÃ¡ÂºÂ¡n AI"
                showBackIcon
            />
            ...
            {messages.length > 1 && (
                <button
                    ...
                    className="absolute top-14 right-4 z-10 bg-white/80 backdrop-blur text-xs text-gray-500 hover:text-red-500 px-3 py-1.5 rounded-full shadow-sm border border-gray-100 transition-colors"
                >
                    XÃƒÂ³a lÃ¡Â»â€¹ch sÃ¡Â»Â­
                </button>
            )}

            <div className="flex-1 overflow-hidden relative bg-white flex flex-col mt-2 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] rounded-t-2xl">
                {/* Chat Area */}
                        ...
                        >
                            ...
                            >
                                ...
                                {msg.action && msg.action.type === "PROCEDURE" && (
                                    <div className="mt-3 border-t border-gray-100 pt-3">
                                        ...
                                        >
                                            Ã°Å¸â€˜â€° Xem chi tiÃ¡ÂºÂ¿t &
                                            NÃ¡Â»â„¢p hÃ¡Â»â€œ sÃ†Â¡
                                        </button>
                                    </div>
                                )}
                            </div>
                            ...
                            {!msg.isBot && (
                                <div className="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center shrink-0 shadow-sm overflow-hidden">
                                    <img
                                        src="https://ui-avatars.com/api/?name=Cong+Dan&background=e0f2fe&color=0369a1"
                                        alt="Avatar"
                ...
                <div className="p-3 bg-white border-t border-gray-100 pb-safe">
                    <div className="bg-gray-50 p-1.5 rounded-full flex items-center gap-2 border border-gray-200 shadow-inner">
                        <input
                            ...
                            placeholder="BÃ¡ÂºÂ¡n muÃ¡Â»â€˜n hÃ¡Â»Âi gÃƒÂ¬?"
