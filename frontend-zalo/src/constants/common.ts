...
export const API = {
    ...
    GET_ARTICLES: "/news",
    FEEDBACK: "/feedbacks",
    FEEDBACK_TYPES: "/feedbacks/types",
    INFORMATION_GUIDE: "/procedures",
    UPLOAD_IMAGE: "/upload/images",
    CREATE_SCHEDULE: "/appointments",
    GET_SCHEDULE: "/appointments",
    GET_SCHEDULES: "/appointments",
    WEATHER: "/weather",
    ...
    LEGAL_DOCUMENT_DETAIL: "/documents/:id",
    HOME_STATS: "/home-sections",
    HOTLINES: "/hotlines",
