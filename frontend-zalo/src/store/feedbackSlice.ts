...
const feedbackSlice: StateCreator<FeedbackSlice> = (set, get) => ({
    ...
    createFeedback: async (
        ...
        try {
            ...
            const rs = await api.createFeedback(feedback, organizationId);
    ...
    getFeedbacks: async (params: GetFeedbacksParams) => {
        try {
            ...
            const feedbacks = await api.getFeedbacks(params);
    ...
    getFeedbackTypes: async (params: GetFeedbackTypeParams) => {
        try {
            ...
            const feedbackTypes = await api.getFeedbackTypes(params);
            set(state => ({
                ...state,
